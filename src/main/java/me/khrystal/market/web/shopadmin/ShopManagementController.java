...
//    }
    ...
    /**
     * 判断前端页面是否能够访问某个店铺的编辑页 管理session的操作
     * 即 session或request中存在shopId
     * 如果不存在 则重定向回店铺列表页
     * @param request
     * @return
     */
    ...
    private Map<String, Object> getShopManagementInfo(HttpServletRequest request) {
        ...
        if (shopId <= 0) {
            ...
            if (currentShopObj == null) {
                ...
                modelMap.put("url", "/market/shop/shoplist");
            } else {
